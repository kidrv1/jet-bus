                    ...
                    @foreach($packages as $package)
                      <tr>
                        ...
                        <td class="align-middle text-center">
                          <span class="text-secondary text-xs font-weight-bold">{{$package->package_rate}}</span>
                        </td>
  ...
  <div class="modal" id="createModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form role="form" action="{{route('admin_bus_package_check')}}" method="POST" enctype="multipart/form-data">
        <!-- Modal body -->
        ...
        <div class="mb-3">
          ...
          <input type="checkbox" name="inclusion[]" value="Tour Fee (activities, itinerary)"/> Tour Fee (activities, itinerary) </br>
