...
<body class="g-sidenav-show   bg-gray-100">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Customer Highlights</li>
                    </ol>
                </nav>
                                            ...
                                            <tr>
                                                <td class="text-center text-sm">
                                                    <a
                                                        ...
                                                        target="_blank">
                                                        <img
                                                        src="{{ URL::to('/') }}/testimonials/{{ $testimonial->image }}"
                                                        alt="Card image" width="120px" height="120px">
                                                    </a>
                                                </td>
                                                <td class="align-middle">
                                                    <button
                                                        onclick="deleteImage({{ $testimonial->id }})"
                                                        class="btn btn-danger btn-xs archive">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
    ...
    <div class="modal" id="delete-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form role="form" action="{{ route("admin_testimonials_delete") }}" method="POST">
                    <!-- Modal body -->
                    <div class="modal-body">
                        @csrf
                        <input type="hidden" name="image_id" id="remove_image_id">
                        This image will no longer be shown in the front page
                    </div>
                    <!-- Modal footer -->
    ...
    <div class="modal" id="create-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form
                    role="form"
                    action="{{ route('admin_testimonials_store') }}"
                    method="POST"
    ...
    <script type="text/javascript">
        const deleteImage = async (id) => {
            const idField = document.querySelector("#remove_image_id");
            idField.value = id;
