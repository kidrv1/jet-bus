...
<body>
    ...
    <div id="spinner" class="loading-spinner d-flex">
        <div class="col align-self-center text-center">
            <img height="200px" width="200px" class="img-fluid bg-light p-1" src="img/loading-bus.gif" alt="loading animation">
        </div>
    </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route("feedback") }}" class="nav-item nav-link">Feedback(Temp Route)</a>
                            ...
                            @auth
                                ...
                                <a href="{{ route("customer_booking_list") }}" class="nav-item nav-link d-block d-lg-none">My Bookings</a>
                                <div class="dropdown-divider"></div>
                                <a href="{{ route("admin_logout") }}" class="nav-item nav-link d-block d-lg-none">Logout</a>
                            @endauth
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{ route("customer_booking_list") }}" class="dropdown-item" type="button">My Bookings</a>
                                    <a href="{{ route("admin_logout") }}" class="dropdown-item" type="button">Logout</a>
                                </div>
                            </div>
                            <div class="btn px-0 ml-3 dropleft">
                                <button class="btn btn-sm btn-primary dropdown-toggle" type="button" id="notificationDropDown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-bell text-white"></i>
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">0</span>
                                </button>
                                <div style="width: 400px;" class="dropdown-menu" aria-labelledby="notificationDropDown">
                                    ...
                                    <a class="dropdown-item" href="{{ route("notifications") }}">
                                        <div class="card border-0">
                                            <div class="d-flex justify-content-between  align-items-center">
                                                <div class="d-flex  align-items-center">
                                                    <i style="font-size: 1.6em;" class="fas fa-times-circle mr-2 text-danger"></i>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-secondary mb-2" href="{{ route("customer_booking_packages") }}"><i class="fa fa-angle-right mr-2"></i>Booking</a>
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            @endguest
                            @auth
                                <a class="text-secondary mb-2" href="{{ route("customer_booking_list") }}"><i class="fa fa-angle-right mr-2"></i>My Bookings</a>
                                <a class="text-secondary mb-2" href="{{ route("admin_logout") }}"><i class="fa fa-angle-right mr-2"></i>Logout</a>
                            @endauth
                        </div>
                    </div>
                    <div class="col-md-4 mb-5">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    &copy; <a class="text-primary" href="{{ route("home") }}">Jet Bus Travel and Tours</a>. All Rights Reserved
                </p>
            </div>
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img height="100px" width="70px" class="img-fluid bg-light p-1" src="img/gcash.svg" alt="pay with gcash">
            </div>
        </div>
    </div>
    <!-- Footer End -->
